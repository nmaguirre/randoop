  ...
  public boolean handle(String[] args) throws RandoopTextuiException {
    ...
    */
	...
	//if (AbstractGenerator.field_based_gen != null) {
		...
		System.out.println("> Field Based Generation Option: --field-based-gen-observers-per-test=" + AbstractGenerator.fbg_observers_per_test);
...
//		System.out.println("> Field Based Generation Option: --field-based-gen-keep-negative-tests-percentage=" + AbstractGenerator.keep_negative_tests_percentage);
	...
	if (FieldBasedGenLog.isLoggingOn()) {
		...
		FieldBasedGenLog.logLine("> Field Based Generation Option: --field-based-gen-observers-per-test=" + AbstractGenerator.fbg_observers_per_test);
    ...
    if (VectorsWriter.isEnabled()) {
    	explorer.initNewCanonicalizerForVectorization(classnames, AbstractGenerator.fbg_max_objects, 
    		...
    		if (AbstractGenerator.vectorization_max_array_objects == Integer.MAX_VALUE)
    			AbstractGenerator.vectorization_max_array_objects = AbstractGenerator.vectorization_max_objects;
    }
    else
