  ...
  public boolean handle(String[] args) throws RandoopTextuiException {
    ...
    */
	...
	//if (AbstractGenerator.field_based_gen != null) {
		...
		System.out.println("> Field Based Generation Option: --field-based-max-non-extending-tests-for-modifier-ratio=" + AbstractGenerator.field_based_gen_max_non_extending_tests_for_modifier_ratio);
...
//		System.out.println("> Field Based Generation Option: --field-based-gen-keep-negative-tests-percentage=" + AbstractGenerator.keep_negative_tests_percentage);
	...
	if (FieldBasedGenLog.isLoggingOn()) {
		...
		FieldBasedGenLog.logLine("> Field Based Generation Option: --field-based-max-non-extending-tests-for-modifier-ratio=" + AbstractGenerator.field_based_gen_max_non_extending_tests_for_modifier_ratio);
