...
public class TestFieldExtensionsStringsTheory {
	...
	public void testSinglyLinedListWithInnerNode(Object o1, Object o2) {
		...
		FieldExtensionsCollector collector = new FieldExtensionsStringsCollector(maxObjects);
		...
		*/
		...
		FieldExtensionsCollector collector2 = new FieldExtensionsStringsCollector(maxObjects);
		canonRes = candVectCanonizer.traverseBreadthFirstAndCanonicalize(o2, collector2);
		Assert.assertTrue(canonRes.getKey() == CanonicalizationResult.OK);
		FieldExtensionsStrings ext2 = (FieldExtensionsStrings) collector2.getExtensions();
		/*
